...
internal class Middle_Fail_Inject_BrainDeath : Middle_Fail_Inject
{
    ...
    public override void RunOnPawn(Pawn pawn, PowerDef power)
    {
        ...
        SendLetter("VFEEA_ExtractPWR.InjectMiddleFailed.BrainDeath".Translate(power.label), pawn.Corpse);
    }
}